...
public class BaseHelper{
    ...
    public void swipe(double start, double stop) {
        ...
        new TouchAction((PerformsTouchActions) driver).longPress(PointOption.point(x, startY)).moveTo(PointOption.point(x, stopY)).release().perform();
    }
    ...
    public void swipeByElement(By locator, double startPoint, double stopPoint){
        ...
        new TouchAction((PerformsTouchActions) driver).longPress(PointOption.point(middleX, startY)).moveTo(PointOption.point(middleX, stopY)).release().perform();
    }
