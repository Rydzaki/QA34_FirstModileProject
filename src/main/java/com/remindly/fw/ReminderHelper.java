...
public class ReminderHelper extends BaseHelper{
    ...
    public void selectTime(String timeOfDay, int xHour, int yHour, int xMin, int yMin) {
        ...
        if(timeOfDay.equals("am")){
            tapWithCoordinates(280, 1335);
        } else if (timeOfDay.equals("pm")) {
            tapWithCoordinates(800, 1335);
        }
    ...
    public void tapRepetitionIntervalField() {
        tap(By.id("RepeatNo"));
    }
    ...
    public void tapOnOkRepetition() {
        tapWithCoordinates(870, 1065);
        //tap(By.id("button2"));
    }

    public void selectTypeOfRepetitions(String interval) {
        tap(By.id("RepeatType"));
        pause(500);
        tap(By.xpath("//android.widget.TextView[@resource-id=\"android:id/text1\" and @text=\""+interval+"\"]"));
    }

    public void selectRepetitionField() {
        swipe(0.8, 0.6);
    }
}
